...
//   concept: string;  // Concept ID as a string
//   description: string;  // Description of the service
// }

export interface Schema {
  services: {
    all: Service[]; // Services applicable to all
    'program:HIV'?: Service[]; // Services related to the HIV program
    'program:TB'?: Service[]; // Services related to the TB program
    'age<5'?: Service[]; // Services related to age < 5
...
export interface FormSchema {
  services: {
    ...
    'program:TB'?: Service[]; // Services related to the TB program
    'age<5'?: Service[]; // Services related to age < 5
    'visitAttribute:prisoner'?: Service[]; // Services related to prisoners
  };
  commodities: Record<string, unknown>;
}
