...
const PartographChart: React.FC<PartographChartProps> = ({ partograpyComponents }) => {
  ...
  const partographSigns = [
    {
      id: 'fetalHeartRate',
      title: withUnit('Heart Rate', convertedData[0]?.fetalHeartRate?.toString() ?? '-'),
      value: 'fetalHeartRate',
    },
    {
      id: 'cervicalDilation',
      title: withUnit('Cervical Dilation', convertedData[0]?.cervicalDilation?.toString() ?? '-'),
      value: 'cervicalDilation',
    },
    {
      id: 'descentOfHead',
      title: withUnit('Descent of Head', convertedData[0]?.descentOfHead?.toString() ?? '-'),
      value: 'descentOfHead',
    },
  ];
