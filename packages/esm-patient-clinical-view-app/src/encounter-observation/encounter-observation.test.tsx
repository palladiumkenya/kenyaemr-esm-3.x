...
describe('EncounterObservations Component', () => {
  it('renders loading skeleton when observations are not available', () => {
    render(<EncounterObservations {...emptyTestProps} />);
  ...
  describe('mapConceptToFormLabel', () => {
    it('returns defaultValue when formConceptMap is undefined', () => {
      const result = mapConceptToFormLabel('conceptUuid', undefined, 'Alive');
