...
import VisitDetailOverviewComponent from './case-management/encounter/case-encounter-overview.component';
...
export const caseEncounterOverview = getSyncLifecycle(VisitDetailOverviewComponent, options);
