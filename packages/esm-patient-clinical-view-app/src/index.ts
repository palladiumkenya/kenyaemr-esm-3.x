...
import { ClinicalDashboardGroup, mchDashboardMeta, defaulterTracingDashboardMeta,enhancedAdheranceDashboardMeta } from './dashboard.meta';
...
export const enhancedAdherenceLink = getSyncLifecycle(createDashboardLink(enhancedAdheranceDashboardMeta, moduleName }), options);
