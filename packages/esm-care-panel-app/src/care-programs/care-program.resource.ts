...
const programForms = [
  ...
  },
  {
    ...
    forms: [
      { formName: 'Child welfare clinic form', formUuId: '755b59e6-acbb-4853-abaf-be302039f902' }, // CWC followup
      { formName: 'MCH Postnatal Visit Form', formUuId: '72aa78e0-ee4b-47c3-9073-26f3b9ecc4a7' },
  ...
  },
  {
    ...
    forms: [
      { formName: 'TB Enrollment', formUuId: '89994550-9939-40f3-afa6-173bce445c79' },
      { formName: 'TB FollowUp', formUuId: '2daabb77-7ad6-4952-864b-8d23e109c69d' },
      { formName: 'TB Discontinuation', formUuId: '4b296dd0-f6be-4007-9eb8-d0fd4e94fb3a' },
    ],
  },
  {
    ...
    forms: [
      { formName: 'Violence enrollment', formUuId: '9ba1d4aa-57d7-48f9-a635-a23508e8136c' },
      ...
      { formName: 'Violence Legal Form', formUuId: 'd0c36426-4503-4236-ab5d-39bff77f2b50' },
      { formName: 'Violence Perpetrator Details', formUuId: 'f37d7e0e-95e8-430d-96a3-8e22664f74d6' },
      { formName: 'PEP FOLLOWUP Form', formUuId: '155ccbe2-a33f-4a58-8ce6-57a7372071ee' },
      { formName: 'Violence Discontinuation Form', formUuId: '8fed3d06-f8a1-4cb8-b853-cd93394bab79' },
    ],
  },
  {
    programName: 'TPT',
    ...
    forms: [
      { formName: 'TPT Initiation', formUuId: '61ea2a72-b0f9-47cf-ae86-443f88656acc' },
      { formName: 'TPT FollowUp', formUuId: '9d0e4be8-ab72-4394-8df7-b509b9d45179' },
      { formName: 'TPT Outcome/Discontinuation', formUuId: '5bdd3b65-8b7b-46a0-9f7b-dfe764143848' },
    ],
  },
  {
    programName: 'PrEP',
    ...
    forms: [
      { formName: 'PrEP Initial Form', formUuId: '1bfb09fc-56d7-4108-bd59-b2765fd312b8' },
      { formName: 'PrEP INITIATION', formUuId: 'd5ca78be-654e-4d23-836e-a934739be555' },
      { formName: 'PrEP Follow Up', formUuId: 'ee3e2017-52c0-4a54-99ab-ebb542fb8984' },
      { formName: 'PrEP Monthly Refill Form', formUuId: '291c03c8-a216-11e9-a2a3-2a2ae2dbcce4' },
    ],
  },
  {
    programName: 'NCD',
  ...
  },
  {
    ...
    forms: [
      { formName: 'KVP Contact Form', formUuId: '185dec84-df6f-4fc7-a370-15aa8be531ec' },
      { formName: 'KVP Clinical Enrollment', formUuId: 'c7f47cea-207b-11e9-ab14-d663bd873d93' },
      { formName: 'KVP Clinical Encounter form', formUuId: '92e041ac-9686-11e9-bc42-526af7764f64' },
      { formName: 'KVP Client Discontinuation', formUuId: '1f76643e-2495-11e9-ab14-d663bd873d93' },
    ],
  },
  {
    ...
    forms: [
      { formName: 'HIV Enrollment', formUuId: 'e4b506c1-7379-42b6-a374-284469cba8da' },
      { formName: 'ART Readyness', formUuId: '782a4263-3ac9-4ce8-b316-534571233f12' }, // USING ART prepairation form (closest to readiness)
      { formName: 'HIV Green Card', formUuId: '22c68f86-bbf0-49ba-b2d1-23fa7ccf0259' },
      { formName: 'HIV Discontinuation', formUuId: 'e3237ede-fa70-451f-9e6c-0908bc39f8b9' },
    ],
  },
