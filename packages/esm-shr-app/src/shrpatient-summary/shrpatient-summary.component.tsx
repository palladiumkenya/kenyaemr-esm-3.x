                        ...
                        <Tabs className={`${styles.verticalTabs} ${layout === 'tablet' ? styles.tabletTabs : styles.desktopTabs}`}>
                            <TabList aria-label="Shared Medical Record tabs" className={styles.tablist}>
                                ...
                                <Tab className={styles.tab} 
                                    id="labresults-tab" 
                                    disabled={data?.labResults.length <= 0}>
                                    {t('labresults', 'labResults')}
                                </Tab>
                                <Tab
                                    className={styles.tab}
                                    id="complaints-tab"
                                    disabled={data?.complaints.length <= 0}
                                >
                                ...
                                <Tab
                                    className={styles.tab}
                                    id="diagnosis-tab"
                                    disabled={data?.diagnosis.length <= 0}
                                >
                                ...
                                <Tab
                                    className={styles.tab}
                                    id="allergies-tab"
                                    disabled={data?.allergies.length <= 0}
                                >
                                ...
                                <Tab
                                    className={styles.tab}
                                    id="medications-tab"
                                    disabled={data?.medications.length <= 0}
                                >
